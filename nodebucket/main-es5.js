...
/* harmony import */ var _angular_material_tree__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! @angular/material/tree */ "./node_modules/@angular/material/esm5/tree.es5.js");
...
/* harmony import */ var _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! @angular/cdk/drag-drop */ "./node_modules/@angular/cdk/esm5/drag-drop.es5.js");
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.updateTaskList = function (empId, todo, done) {
        var _this = this;
    ...
    HomeComponent.prototype.openCreateTaskDialog = function () {
        var _this = this;
        var dialogRef = this.dialog.open(src_app_shared_create_task_dialog_create_task_dialog_component__WEBPACK_IMPORTED_MODULE_6__["CreateTaskDialogComponent"], {
            disableClose: true
        });
        dialogRef.afterClosed().subscribe(function (data) {
            if (data) {
                _this.taskService.createTask(_this.empId, data.text).subscribe(function (res) {
                    _this.employee = res.data;
                }, function (err) {
                    console.log(err);
                }, function () {
    ...
    SigninComponent.prototype.login = function () {
        ...
        this.http.get('/api/employees/' + empId).subscribe(function (res) {
            if (res) {
                ...
                _this.cookieValue = _this.cookieService.get('session_user');
...
var CreateTaskDialogComponent = /** @class */ (function () {
    ...
    CreateTaskDialogComponent.prototype.createTask = function () {
        this.dialogRef.close(this.taskForm.value);
    };
    // this will cancel & closed the form
    CreateTaskDialogComponent.prototype.cancel = function () {
        this.dialogRef.close();
    };
    CreateTaskDialogComponent.ctorParameters = function () { return [
...
var TaskService = /** @class */ (function () {
     ...
     * ==============================================================================
    */
    TaskService.prototype.findAllTasks = function (empId) {
     ...
     * ==============================================================================
    */
    TaskService.prototype.updateTask = function (empId, todo, done) {
   ...
   * ==============================================================================
  */
    TaskService.prototype.createTask = function (empId, task) {
   ...
   * ==============================================================================
  */
    TaskService.prototype.deleteTask = function (empId, taskId) {
